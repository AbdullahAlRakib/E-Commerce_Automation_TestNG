 ...
 */
    ...
    //getting user credentials from JSON.
     ...
     //WRITE JSON LIST
    public void writeUserInfo(String email,String password) throws IOException, org.json.simple.parser.ParseException {
            String fileName="./src/test/resources/users.json";
        JSONParser jsonParser = new JSONParser();
        Object obj = jsonParser.parse(new FileReader(fileName));
    ...
    public int getUserCount() throws IOException, org.json.simple.parser.ParseException {
        String fileName="./src/test/resources/users.json";
        JSONParser jsonParser= new JSONParser();
        Object obj=jsonParser.parse(new FileReader(fileName));
        JSONArray jsonArray=(JSONArray) obj;
